...
function RedirectComponent() {
  useEffect(() => {
    window.location.href = 'https://asfischolar.net'; // External URL
  }, []);

  return null; // Don't render anything, just redirect
}

// function RedirectPhraseComponent() {
//   useEffect(() => {
//     window.location.href = 'https://asfischolar.net/v9'; // External URL
//   }, []);
...
function AppRoutes() {
  ...
  return (
    <Switch>
      ...
      {RenderCustomRoutes()}
      <Route exact path={'/v6/:phrase'} component={VideoCallWrapper} />
      <Route path="*">
